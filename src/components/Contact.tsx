      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 font-medium">
            Available for freelance contracts, e-commerce graphic design projects, and remote brand collaborations worldwide.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Location */}
            <div className="rounded-3xl bg-white dark:bg-[#0d0d0d] p-6 border border-slate-200 dark:border-[#8b5cf6]/20 shadow-md flex items-center justify-between">
            ...
            <div className="rounded-3xl bg-white dark:bg-[#0d0d0d] p-6 border border-slate-200 dark:border-[#8b5cf6]/20 shadow-md flex items-center justify-between">
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-slate-100 dark:bg-black border border-slate-200 dark:border-neutral-800 text-slate-700 dark:text-slate-200 hover:text-[#8b5cf6]"
          ...
          {/* Form */}
          <div className="lg:col-span-7 rounded-3xl bg-white dark:bg-[#0d0d0d] p-8 sm:p-10 border border-slate-200 dark:border-[#8b5cf6]/30 shadow-lg">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300 font-medium mb-8">
              Fill out your project details below to initiate a direct pre-formatted WhatsApp consultation with Rameen Fatima.
            </p>
            ...
            <form onSubmit={handleWhatsAppSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-black border border-slate-200 dark:border-neutral-800 text-slate-900 dark:text-white text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-black border border-slate-200 dark:border-neutral-800 text-slate-900 dark:text-white text-sm focus:outline-none focus:border-[#8b5cf6] transition-colors cursor-pointer"
                >
                  <option value="Product Image Design (Amazon)" className="bg-white dark:bg-black text-slate-900 dark:text-white">Product Image Design (Amazon Listing)</option>
                  <option value="Shopify Store Design" className="bg-white dark:bg-black text-slate-900 dark:text-white">Shopify Store Design</option>
                  <option value="Canva & Illustrator Graphics" className="bg-white dark:bg-black text-slate-900 dark:text-white">Canva &amp; Illustrator Graphics</option>
                  <option value="Logo & Brand Identity" className="bg-white dark:bg-black text-slate-900 dark:text-white">Logo &amp; Brand Identity Design</option>
                  <option value="WordPress Website Design" className="bg-white dark:bg-black text-slate-900 dark:text-white">WordPress Website Design (Learning Service)</option>
                </select>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-black border border-slate-200 dark:border-neutral-800 text-slate-900 dark:text-white text-sm focus:outline-none focus:border-[#8b5cf6] resize-none transition-colors"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#8b5cf6] hover:bg-[#7c3aed] py-4 rounded-xl font-extrabold text-slate-950 text-sm flex items-center justify-center gap-2 transition-colors duration-200"
              >
